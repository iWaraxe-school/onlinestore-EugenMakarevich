...
public class DBConstants {
    ...
    public static final String CHECK_IF_TABLE_EXISTS = "SELECT count(*) FROM information_schema.tables WHERE table_name = ? LIMIT 1;";
    public static final String SELECT_CATEGORY_PRODUCTS = "SELECT * FROM products where category_id = ?";
